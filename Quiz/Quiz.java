...
public class Quiz {
    private List<Quizqustion> qustions;
    ...
    public void addQustions(Quizqustion q){
        qustions.add(q);
    }

    public void startquiz(){
        for (Quizqustion q :qustions){
            displayQ(q);
    ...
    private void displayQ(Quizqustion qua){
    ...
    private boolean answerqustion(Quizqustion qua){
    ...
    public static void main(String[] args) {
        Quiz q=new Quiz();
        Quizqustion q1=new Quizqustion("WHO IS PRIME_MINISTER OF INDIA ?");
        ...
        Quizqustion q2=new Quizqustion("Which is the financial capital of INDIA");
